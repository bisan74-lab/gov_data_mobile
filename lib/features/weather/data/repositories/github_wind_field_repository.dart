...
///
/// **이 파일은 골프윈디 자체가 아니라 바다윈디(BadaMobile)의 공개 데이터
/// 저장소(`bisan74-lab/badawindy-data`, [Env.windDataUrl] 기본값)가 만든다.**
/// 두 앱의 지도 bbox·격자 포맷이 완전히 같아서(2026-08 재동기화), 골프윈디가
/// 같은 데이터를 Open-Meteo에 또 요청할 필요가 없다 — 그러면 완전히 같은
/// 결과를 중복으로 받아오는 낭비이자 호출 한도를 불필요하게 이중으로 쓰는
/// 셈이다.
///
